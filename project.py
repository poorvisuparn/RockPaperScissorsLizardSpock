...
def play():    
    ...
    sb1=Button(rpsls,text='Rock',command=Rock,font="Times").pack()
    sb2=Button(rpsls,text='Paper',command=Paper,font="Times").pack()
    sb3=Button(rpsls,text='Scissors',command=Scissors,font="Times").pack()
    sb4=Button(rpsls,text='Lizard',command=Lizard,font="Times").pack()
    sb5=Button(rpsls,text='Spock',command=Spock,font="Times").pack()
